...
// Forward declarations for external hooks in tq_hooks.cu
struct ggml_backend_cuda_context;
extern "C" bool tq_on_set_rows(ggml_backend_cuda_context & ctx, const ggml_tensor * dst);
extern "C" bool tq_on_flash_attn(ggml_backend_cuda_context & ctx, const ggml_tensor * dst);
        ...
        case GGML_OP_SET_ROWS:
            {
                ...
                if (dst->src[0]->type == GGML_TYPE_IQ1_S) {
                    ...
                    return true; // ALWAYS SKIP FOR IQ1_S
                }
#endif
            }
